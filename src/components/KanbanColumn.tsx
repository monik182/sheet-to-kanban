...
export function KanbanColumn({ status, cards, onDrop, onDragStart, onDragEnd, onEdit, onBuildWithAI }: KanbanColumnProps) {
  ...
  return (
    <div
      className={`flex flex-col min-w-[280px] w-[280px] border-4 transition-colors duration-150 ${
        isDragOver
